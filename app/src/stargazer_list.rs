//! Discovered stargazer data — the plain structs behind the stargazer list UI.
//!
...
/// A single stargazer seen on the gossip swarm (announce received).
#[derive(Debug, Clone)]
pub struct DiscoveredStargazer {
    pub peer_id: PeerId,
    pub solar_month: u8,
